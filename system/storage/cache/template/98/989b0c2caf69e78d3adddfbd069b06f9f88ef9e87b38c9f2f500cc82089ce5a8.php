...
/* sanengineering/template/product/product.twig */
class __TwigTemplate_9c7aaf6c357e1815cca070f016a6cf0ed2c329a341a400b08ac7f870d59021c7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\twindow.top.location.href= 'http://localhost/sanstore/index.php?route=checkout/cart';
\t\t\t\t\t  }
\t\t\t\t\t})
\t\t\t\t\$('#cart > button').html('<img src=\"image/catalog/cart-icon-new.png\" class=\"shop-cart-img\" alt=\"cart\"><span id=\"cart-total\"><span class=\"shop-cart\"> ' + 'Shopping Cart' + '</span>'+ json['total'] + '</span>');
...
";
    ...
    {
        return "sanengineering/template/product/product.twig";
    }
